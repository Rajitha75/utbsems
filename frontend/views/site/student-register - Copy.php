...
<div class="site-login">
    ...
    echo $form->field($userformmodel, 'dob')->widget(\yii\jui\DatePicker::classname(), [
		...
		<?php echo $form->field($userformmodel, 'type_of_entry')->dropDownList(['HECAS' => 'HECAS', 'In-service' => 'In-service'],['prompt' => 'Select Type of Entry'])->label('Type of Entry <span class="mandatory">*</span>');?>

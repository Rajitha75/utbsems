                            ...
                            <div class="profile-page participation-border">
                                <div class="row">
                                    ...
                                    <div class='col-xs-12 col-sm-12'>
                                        <?= $form->field($model, 'contact_name')->textInput(['autofocus' => true,'autocomplete' => 'off'])->label('Name <span class="mandatory">*</span>') ?>

                                        <?= $form->field($model, 'contact_email')->textInput(['autocomplete' => 'off'])->label('Email <span class="mandatory">*</span>') ?>

                                        <?= $form->field($model, 'contact_body')->textArea(['rows' => 6,'autocomplete' => 'off'])->label('Message <span class="mandatory">*</span>') ?>

                                        <?=
                                        $form->field($model, 'contact_verifyCode')->widget(Captcha::className(), [
                                        ...
                                        ])->label('Captcha <span class="mandatory">*</span>')
                                        ?>
...
<script>
    // To visible page scroll bar
    $('html').removeClass('intro-over');
</script>

...
if(($flash = Yii::$app->session->getFlash('profilesaved')) || ($flash=Yii::$app->session->getFlash('profile_changed'))){
                ...
                <div class="portlet-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1_1">
                             <?php echo Yii::$app->controller->renderPartial('/profile/profile', ['userdata' => $userdata, 'userdata_ref' =>$userdata_ref, 'userdatamodel' =>$userdatamodel, 'userformmodel' => $userformmodel, 'countries' => $countries, 'countrycodes' => $countrycodes,'allUserImages'=>@$allUserImages,'allUserVideos'=>@$allUserVideos,]); ?>
                        </div>

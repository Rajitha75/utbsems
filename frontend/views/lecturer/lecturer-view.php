...
<div class="center-table">
       ...
       <?php //print_r($lecturerdetails); exit;
        echo DetailView::widget([
                ...
                'attributes' => [
                    [
                        'attribute' => 'Name',
                        'value' => stripslashes($lecturerdetails['name']),
                    ], 
                    [
                        'attribute'=>'Gender',
                        'value' => stripslashes($lecturerdetails['gender']),
                    ],
                    [
                        'attribute'=>'Martial Status',
                        'value' => stripslashes($lecturerdetails['martial_status']),
                    ],
                    
                    [
                        'attribute'=>'Age',
                        'value' => stripslashes($lecturerdetails['age']),
                    ],
                    [
                        'attribute'=>'Place of Birth',
                        'value' => stripslashes($lecturerdetails['place_of_birth']),
                    ],
		    [
                        'attribute'=>'Telephone No. (Mobile)',
                        'value' => stripslashes($lecturerdetails['telephone_mobile']),
                    ],
		    [
                        'attribute'=>'Telephone No. (Home)',
                        'value' => stripslashes($lecturerdetails['tele_home']),
                    ],
                    [
                        'attribute'=>'IC No',
                        'value' => stripslashes($lecturerdetails['ic_no']),
                    ],
                    [
                        'attribute'=>'Passport No',       
                        'value' => stripslashes($lecturerdetails['passportno']),
                    ],
                    [
                        'attribute'=>'Email',       
                        'value' => stripslashes($lecturerdetails['email']),
                    ],
                    [
                        'attribute'=>'Email (Other)',       
                        'value' => stripslashes($lecturerdetails['emailother']),
                    ],
                ],
        ]);
?>

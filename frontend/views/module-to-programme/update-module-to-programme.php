...
$moduleprogrammeformmodel->module_id = $data['module_id'];
$moduleprogrammeformmodel->programme_id = $data['programme_id'];
$moduleprogrammeformmodel->semister = $data['semister'];
?>
<?php 
$this->title = 'Update Module to Programme';
...
<div class="site-login container">
 ...
 <?php $form = ActiveForm::begin([
			'method' => 'post',
			'action' => 'update-module-to-programme',
			'id' => 'addfacultyform',
			'options' => ['enctype' => 'multipart/form-data'],
			]); ?>
	<div class="col-xs-8 col-sm-6">
	<?php echo $form->field($moduleprogrammeformmodel, 'id')->hiddenInput(['autocomplete' => 'off','value'=>!empty(Yii::$app->getRequest()->getQueryParam('id')) ? Yii::$app->getRequest()->getQueryParam('id') : ''])->label(false);?>

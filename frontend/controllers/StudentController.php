...
Yii::$app->cache->flush();
    ...
    public function actionStudentEditProfile(){
		...
		if($postvariable['is_submit'] == 'submit'){
			...
			$studentkindetails = StudentKinDetails::getStudentKinDetailsByStudentId(Yii::$app->user->id);
			$studenthqdetails = StudentHighestQualificationDetails::getStudentHighestQualificationDetailsByStudentId(Yii::$app->user->id);

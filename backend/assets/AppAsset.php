...
class AppAsset extends AssetBundle
{
   ...
   // public $sourcePath = '@bower/metronic/views';
    public $css = [
     /* 'style.css', */    
      ...
      /*  'assets/layouts/layout/css/fancybox.css',*/
        'assets/layouts/layout/css/fancybox.min.css',
            
       /*pdf
      // 'assets/layouts/layout/css/bootstrap.min.css', 
       'assets/layouts/layout/css/style-pdf.css', */ 
    ...
    public $js = [        
        ...
        'assets/layouts/global/scripts/fancybox.min.js',
        
       // 'assets/global/scripts/jquery.MultiFile.js',
          'assets/global/scripts/jquery.MultiFile.min.js',

        'assets/global/plugins/ckeditor/ckeditor.js',
        //'assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js',
        
        /*pdf 
        'assets/layouts/layout/scripts/jquery.js',
        'assets/layouts/layout/scripts/bootstrap.js',*/

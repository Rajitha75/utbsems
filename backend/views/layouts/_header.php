...
if (($flash = Yii::$app->session->getFlash('studentverified')) || ($flash = Yii::$app->session->getFlash('studentundoverify')) || ($flash = Yii::$app->session->getFlash('studentdelete')) || ($flash = Yii::$app->session->getFlash('studentundodelete')) || ($flash = Yii::$app->session->getFlash('signupsuccess')) || ($flash = Yii::$app->session->getFlash('admincreatesuccess')) || ($flash = Yii::$app->session->getFlash('studentupdatesuccess')) ) {
